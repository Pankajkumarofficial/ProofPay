  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-[1.1fr_1fr]">
      <aside className="relative hidden overflow-hidden border-r border-ink-300/60 bg-ink-900 lg:flex lg:flex-col lg:justify-between lg:p-12">
        ...
        <div className="relative">
          <Link to="/" className="flex items-center gap-3">
            <svg width="26" height="26" viewBox="0 0 32 32" aria-hidden className="text-brass-300">
        ...
        >
          <p className="label">The primitive</p>
        ...
        {aside ?? (
          <p className="relative label text-paper-400">
      ...
      <main className="relative flex items-center justify-center px-5 py-10 sm:px-10">
        {/* Reachable before signing in — the choice should not require an account. */}
        <ThemeToggleCompact className="absolute right-5 top-5 sm:right-8 sm:top-8" />
